...
use v1::types::{H160, H256, DappId, DerivateHash, DerivateHierarchical};
...
build_rpc_trait! {
	...
	pub trait ParityAccounts {
		...
		fn derive_key_hash(&self, H160, String, DerivateHash, bool) -> Result<H160, Error>;
		...
		fn derive_key_index(&self, H160, String, DerivateHierarchical, bool) -> Result<H160, Error>;
	}
}
