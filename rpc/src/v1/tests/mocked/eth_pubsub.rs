...
fn should_subscribe_to_new_heads() {
	...
	// And unsubscribe
	let request = r#"{"jsonrpc": "2.0", "method": "eth_unsubscribe", "params": ["416d77337e24399dc7a5aa058039f72a"], "id": 1}"#;
