...
fn should_subscribe_to_new_heads() {
	...
	// And unsubscribe
	let request = r#"{"jsonrpc": "2.0", "method": "eth_unsubscribe", "params": ["416d77337e24399d"], "id": 1}"#;
