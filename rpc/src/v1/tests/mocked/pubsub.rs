...
fn should_subscribe_to_a_method() {
	...
	let response = r#"{"jsonrpc":"2.0","result":"416d77337e24399dc7a5aa058039f72a","id":1}"#;
	...
	let response =
		r#"{"jsonrpc":"2.0","method":"parity_subscription","params":{"result":"hello","subscription":"416d77337e24399dc7a5aa058039f72a"}}"#;
	assert_eq!(res, Some(response.into()));

	let (res, receiver) = receiver.into_future().wait().unwrap();
	let response =
		r#"{"jsonrpc":"2.0","method":"parity_subscription","params":{"result":"world","subscription":"416d77337e24399dc7a5aa058039f72a"}}"#;
	assert_eq!(res, Some(response.into()));

	// And unsubscribe
	let request = r#"{"jsonrpc": "2.0", "method": "parity_unsubscribe", "params": ["416d77337e24399dc7a5aa058039f72a"], "id": 1}"#;
