...
mod block_tests {
	...
	declare_test!{BlockchainTests_bcUncleSpecialTests, "BlockchainTests/bcUncleSpecialTests"}
	...
	declare_test!{BlockchainTests_GeneralStateTest_stCodeCopyTest, "BlockchainTests/GeneralStateTests/stCodeCopyTest/"}
