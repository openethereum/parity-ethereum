...
mod tests {
	...
	fn test_bloom_filter_simple() {
		...
		// bloom filter flow block 300054
		let b2 = "".from_hex().unwrap();
		...
		let temp = RandomTempPath::new();
		let bc = BlockChain::new(&genesis, temp.as_path());
		let blocks = bc.blocks_with_bloom(&bloom, 0, 50);
