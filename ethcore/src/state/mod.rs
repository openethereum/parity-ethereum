...
impl<B: Backend> State<B> {
	...
	pub fn into_account(self, account: &Address) -> TrieResult<(Option<Arc<Bytes>>, IMHashMap<H256, H256>)> {
	...
	pub fn patch_account(&self, a: &Address, code: Arc<Bytes>, storage: IMHashMap<H256, H256>) -> TrieResult<()> {
