...
mod tests {
	...
	fn test_bloom_possibilities_single_address_and_topic() {
		let filter = Filter {
			from_block: BlockID::Earliest,
			to_block: BlockID::Latest,
			address: Some(vec!["b372018f3be9e171df0581136b59d2faf73a7d5d".parse().unwrap()]),
			topics: vec![
				Some(vec!["ff74e91598aed6ae5d2fdcf8b24cd2c7be49a0808112a305069355b7160f23f9".parse().unwrap()]),
				None,
				None,
				None,
			]
	...
	fn test_bloom_possibilites_multiple_addresses_and_topics() {
		let filter = Filter {
			...
			to_block: BlockID::Latest,
			address: Some(vec![
						  "b372018f3be9e171df0581136b59d2faf73a7d5d".parse().unwrap(),
						  "b372018f3be9e171df0581136b59d2faf73a7d5d".parse().unwrap(),
			]),
			topics: vec![
				Some(vec![
					 "ff74e91598aed6ae5d2fdcf8b24cd2c7be49a0808112a305069355b7160f23f9".parse().unwrap(),
					 "ff74e91598aed6ae5d2fdcf8b24cd2c7be49a0808112a305069355b7160f23f9".parse().unwrap()
				]),
				Some(vec![
					 "ff74e91598aed6ae5d2fdcf8b24cd2c7be49a0808112a305069355b7160f23f9".parse().unwrap(),
	...
	fn test_filter_matches() {
		let filter = Filter {
			...
			topics: vec![
				Some(vec!["ff74e91598aed6ae5d2fdcf8b24cd2c7be49a0808112a305069355b7160f23f9".parse().unwrap()]),
				Some(vec!["ff74e91598aed6ae5d2fdcf8b24cd2c7be49a0808112a305069355b7160f23fa".parse().unwrap()]),
				None,
				None,
			]
		};
		...
		let entry0 = LogEntry {
			address: "b372018f3be9e171df0581136b59d2faf73a7d5d".parse().unwrap(),
			topics: vec![
				"ff74e91598aed6ae5d2fdcf8b24cd2c7be49a0808112a305069355b7160f23f9".parse().unwrap(),
				"ff74e91598aed6ae5d2fdcf8b24cd2c7be49a0808112a305069355b7160f23fa".parse().unwrap(),
				"ff74e91598aed6ae5d2fdcf8b24cd2c7be49a0808112a305069355b7160f23f9".parse().unwrap(),
			],
			data: vec![]
		};
		...
		let entry1 = LogEntry {
			address: "b372018f3be9e171df0581136b59d2faf73a7d5e".parse().unwrap(),
			topics: vec![
				"ff74e91598aed6ae5d2fdcf8b24cd2c7be49a0808112a305069355b7160f23f9".parse().unwrap(),
				"ff74e91598aed6ae5d2fdcf8b24cd2c7be49a0808112a305069355b7160f23fa".parse().unwrap(),
				"ff74e91598aed6ae5d2fdcf8b24cd2c7be49a0808112a305069355b7160f23f9".parse().unwrap(),
