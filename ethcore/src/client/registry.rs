...
// Command line: --custom-block --jsonabi=reg.json --name=Registry
...
impl Registry {
	pub fn new<F>(address: util::Address, do_call: F) -> Self
		where F: Fn(BlockId, util::Address, Vec<u8>) -> Result<Vec<u8>, String> + Send + Sync + 'static {
		Registry {
	...
	#[allow(dead_code)]
	pub fn can_reverse(&self, block_id: BlockId, _data: &util::Address) -> Result<bool, String>
		 {
		let call = self.contract.function("canReverse".into()).map_err(Self::as_string)?;
		let data = call.encode_call(
			vec![ethabi::Token::Address(_data.clone().0)]
		).map_err(Self::as_string)?;
		let output = call.decode_output((self.do_call)(block_id, self.address.clone(), data)?).map_err(Self::as_string)?;
	...
	#[allow(dead_code)]
	pub fn set_owner(&self, block_id: BlockId, _new: &util::Address) -> Result<(), String>
		 {
		let call = self.contract.function("setOwner".into()).map_err(Self::as_string)?;
		let data = call.encode_call(
			vec![ethabi::Token::Address(_new.clone().0)]
		).map_err(Self::as_string)?;
		call.decode_output((self.do_call)(block_id, self.address.clone(), data)?).map_err(Self::as_string)?;
	...
	#[allow(dead_code)]
	pub fn set_data(&self, block_id: BlockId, _name: &util::H256, _key: &str, _value: &util::H256) -> Result<bool, String>
		 {
	...
	#[allow(dead_code)]
	pub fn confirm_reverse(&self, block_id: BlockId, _name: &str) -> Result<bool, String>
		 {
	...
	#[allow(dead_code)]
	pub fn reserve(&self, block_id: BlockId, _name: &util::H256) -> Result<bool, String>
		 {
	...
	#[allow(dead_code)]
	pub fn drop(&self, block_id: BlockId, _name: &util::H256) -> Result<bool, String>
		 {
	...
	#[allow(dead_code)]
	pub fn get_address(&self, block_id: BlockId, _name: &util::H256, _key: &str) -> Result<util::Address, String>
		 {
	...
	#[allow(dead_code)]
	pub fn set_fee(&self, block_id: BlockId, _amount: util::U256) -> Result<bool, String>
		 {
	...
	#[allow(dead_code)]
	pub fn transfer(&self, block_id: BlockId, _name: &util::H256, _to: &util::Address) -> Result<bool, String>
		 {
	...
	#[allow(dead_code)]
	pub fn owner(&self, block_id: BlockId) -> Result<util::Address, String>
		 {
	...
	#[allow(dead_code)]
	pub fn get_data(&self, block_id: BlockId, _name: &util::H256, _key: &str) -> Result<util::H256, String>
		 {
	...
	#[allow(dead_code)]
	pub fn reserved(&self, block_id: BlockId, _name: &util::H256) -> Result<bool, String>
		 {
	...
	#[allow(dead_code)]
	pub fn drain(&self, block_id: BlockId) -> Result<bool, String>
		 {
	...
	#[allow(dead_code)]
	pub fn propose_reverse(&self, block_id: BlockId, _name: &str, _who: &util::Address) -> Result<bool, String>
		 {
	...
	#[allow(dead_code)]
	pub fn has_reverse(&self, block_id: BlockId, _name: &util::H256) -> Result<bool, String>
		 {
	...
	#[allow(dead_code)]
	pub fn get_uint(&self, block_id: BlockId, _name: &util::H256, _key: &str) -> Result<util::U256, String>
		 {
	...
	#[allow(dead_code)]
	pub fn fee(&self, block_id: BlockId) -> Result<util::U256, String>
		 {
	...
	#[allow(dead_code)]
	pub fn get_owner(&self, block_id: BlockId, _name: &util::H256) -> Result<util::Address, String>
		 {
	...
	#[allow(dead_code)]
	pub fn get_reverse(&self, block_id: BlockId, _name: &util::H256) -> Result<util::Address, String>
		 {
	...
	#[allow(dead_code)]
	pub fn reverse(&self, block_id: BlockId, _data: &util::Address) -> Result<String, String>
		 {
	...
	#[allow(dead_code)]
	pub fn set_uint(&self, block_id: BlockId, _name: &util::H256, _key: &str, _value: util::U256) -> Result<bool, String>
		 {
	...
	#[allow(dead_code)]
	pub fn confirm_reverse_as(&self, block_id: BlockId, _name: &str, _who: &util::Address) -> Result<bool, String>
		 {
	...
	#[allow(dead_code)]
	pub fn remove_reverse(&self, block_id: BlockId) -> Result<(), String>
		 {
	...
	#[allow(dead_code)]
	pub fn set_address(&self, block_id: BlockId, _name: &util::H256, _key: &str, _value: &util::Address) -> Result<bool, String>
		 {
