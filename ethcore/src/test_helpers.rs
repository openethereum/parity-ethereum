...
pub fn generate_dummy_client(block_number: u32) -> Arc<Client> {
	generate_dummy_client_with_spec_and_data(bundle::new_test, block_number, 0, &[])
}
...
pub fn generate_dummy_client_with_data(block_number: u32, txs_per_block: usize, tx_gas_prices: &[U256]) -> Arc<Client> {
	generate_dummy_client_with_spec_and_data(bundle::new_null, block_number, txs_per_block, tx_gas_prices)
}
