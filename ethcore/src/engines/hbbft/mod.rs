...
/// Engine using `Hbbft` proof-of-authority BFT consensus.
pub struct Hbbft {
...
impl Hbbft {
	/// Create a new instance of Hbbft engine.
	pub fn new(our_params: HbbftParams, machine: EthereumMachine) -> Result<Arc<Self>, Error> {
...
mod tests {
	...
	use super::{HbbftParams, Hbbft, EmptyStep, SealedEmptyStep, calculate_score};
	...
	fn reports_skipped() {
		...
		let aura = {
			...
			Hbbft::new(params, machine).unwrap()
		};
