...
pub trait SnapshotService : Sync + Send {
	...
	/// If a restoration is in progress, this will reset it.
	/// From this point on, any previous snapshot may become unavailable. todo[dvdplm] what does this mean? "unavailable" how? to others?
