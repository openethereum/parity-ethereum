...
pub use self::{
    ...
    block_body::{
        Complete as CompleteBodyRequest, Incomplete as IncompleteBodyRequest,
    ...
    contract_code::{
        Complete as CompleteCodeRequest, Incomplete as IncompleteCodeRequest,
    ...
    transaction_index::{
        ...
        Incomplete as IncompleteTransactionIndexRequest, Response as TransactionIndexResponse,
    },
};
...
pub mod block_body {
    ...
    impl Decodable for Response {
        fn decode(rlp: &Rlp) -> Result<Self, DecoderError> {
            use common_types::{header::Header as FullHeader, transaction::UnverifiedTransaction};
...
mod tests {
    ...
    fn headers_roundtrip() {
        ...
        let res = HeadersResponse {
            headers: vec![::common_types::encoded::Header::new(::rlp::encode(
                &Header::default(),
            ))],
        };
