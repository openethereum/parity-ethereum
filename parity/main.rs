...
fn global_cleanup() {
	...
	// The loop is required because of internal reference counter for winsock dll. We don't know how many crates we use,
	// initialize it with 10. There's at least 2 now.
	for _ in 0.. 10 {
