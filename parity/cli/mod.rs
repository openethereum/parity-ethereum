...
usage! {
	...
	}
	{
		...
		["Operating Options"]
			...
			ARG arg_chain: (String) = "sparrow", or |c: &Config| c.parity.as_ref()?.chain.clone(),
			"--chain=[CHAIN]",
			"Specify the blockchain type. CHAIN may be either a JSON chain specification file or sparrow, ethereum, classic, poacore, tobalaba, expanse, musicoin, ellaism, easthub, social, olympic, morden, ropsten, kovan, poasokol, testnet, or dev.",
