...
usage! {
	...
	}
	{
		...
		["API and console options – IPC"]
			...
			"--ipc-apis=[APIS]",
			"Specify custom API set available via JSON-RPC over IPC. APIS is a comma-delimited list of API name. Possible names are: all, safe, web3, net, eth, pubsub, personal, signer, parity, parity_pubsub, parity_accounts, parity_set, traces, rpc, secretstore, shh, shh_pubsub. You can also disable a specific API by putting '-' in the front: all,-personal. safe contains: traces, parity_pubsub",
