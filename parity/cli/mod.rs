...
usage! {
	...
	}
	{
		...
		["Operating Options"]
			...
			"--chain=[CHAIN]",
			"Specify the blockchain type. CHAIN may be either a JSON chain specification file or ethereum, classic, poanet, tobalaba, expanse, musicoin, ellaism, easthub, social, olympic, morden, ropsten, kovan, sokol, testnet, or dev.",
