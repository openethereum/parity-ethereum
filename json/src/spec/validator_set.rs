...
mod tests {
	...
	fn validator_set_deserialization() {
		...
		assert_eq!(deserialized[0], ValidatorSet::List(vec![Address(H160::from_str("0xc6d9d2cd449a754c494264e1809c50e34d64562b").unwrap())]));
		assert_eq!(deserialized[1], ValidatorSet::SafeContract(Address(H160::from_str("0xc6d9d2cd449a754c494264e1809c50e34d64562b").unwrap())));
		assert_eq!(deserialized[2], ValidatorSet::Contract(Address(H160::from_str("0xc6d9d2cd449a754c494264e1809c50e34d64562b").unwrap())));
