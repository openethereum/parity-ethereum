	...
	fn ethash_deserialization() {
		...
		assert_eq!(deserialized, Ethash {
			params: EthashParams {
				...
				dao_hardfork_beneficiary: Some(Address(H160::from_str("0xabcabcabcabcabcabcabcabcabcabcabcabcabca").unwrap())),
				dao_hardfork_accounts: Some(vec![
					Address(H160::from_str("0x304a554a310c7e546dfe434669c62820b7d83490").unwrap()),
					Address(H160::from_str("0x914d1b8b43e92723e64fd0a06f5bdb8dd9b10c79").unwrap()),
					Address(H160::from_str("0xfe24cdd8648121a43a7c86d289be4dd2951ed49f").unwrap()),
					Address(H160::from_str("0x17802f43a0137c506ba92291391a8a8f207f487d").unwrap()),
					Address(H160::from_str("0xb136707642a4ea12fb4bae820f03d2562ebff487").unwrap()),
					Address(H160::from_str("0xdbe9b615a3ae8709af8b93336ce9b477e4ac0940").unwrap()),
					Address(H160::from_str("0xf14c14075d6c4ed84b86798af0956deef67365b5").unwrap()),
					Address(H160::from_str("0xca544e5c4687d109611d0f8f928b53a25af72448").unwrap()),
					Address(H160::from_str("0xaeeb8ff27288bdabc0fa5ebb731b6f409507516c").unwrap()),
					Address(H160::from_str("0xcbb9d3703e651b0d496cdefb8b92c25aeb2171f7").unwrap()),
					Address(H160::from_str("0xaccc230e8a6e5be9160b8cdf2864dd2a001c28b6").unwrap()),
					Address(H160::from_str("0x2b3455ec7fedf16e646268bf88846bd7a2319bb2").unwrap()),
					Address(H160::from_str("0x4613f3bca5c44ea06337a9e439fbc6d42e501d0a").unwrap()),
					Address(H160::from_str("0xd343b217de44030afaa275f54d31a9317c7f441e").unwrap()),
					Address(H160::from_str("0x84ef4b2357079cd7a7c69fd7a37cd0609a679106").unwrap()),
					Address(H160::from_str("0xda2fef9e4a3230988ff17df2165440f37e8b1708").unwrap()),
					Address(H160::from_str("0xf4c64518ea10f995918a454158c6b61407ea345c").unwrap()),
					Address(H160::from_str("0x7602b46df5390e432ef1c307d4f2c9ff6d65cc97").unwrap()),
					Address(H160::from_str("0xbb9bc244d798123fde783fcc1c72d3bb8c189413").unwrap()),
					Address(H160::from_str("0x807640a13483f8ac783c557fcdf27be11ea4ac7a").unwrap()),
				]),
