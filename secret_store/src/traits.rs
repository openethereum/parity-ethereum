...
pub trait DocumentKeyServer: ServerKeyGenerator {
	...
	/// `document_key` is an externally-generated DK, encrypted with SK with `key_id` identifier.
	fn store_document_key(&self, key_id: &ServerKeyId, signature: &RequestSignature, document_key: EncryptedDocumentKey) -> Result<(), Error>;
