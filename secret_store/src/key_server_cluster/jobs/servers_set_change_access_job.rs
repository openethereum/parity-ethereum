...
println!("=== YYY: {:?} / REAL: {} REQUIRED: {}", if is_administrator { JobPartialRequestAction::Respond(true) } else { JobPartialRequestAction::Reject(false) }, new_actual_public, self.administrator);
