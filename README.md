...
3. To configure OpenEthereum, see [our wiki config page](https://openethereum.github.io/wiki/Configuring-OpenEthereum) for details.
...
Be sure to [check out our wiki](https://openethereum.github.io/wiki/) for more information.
