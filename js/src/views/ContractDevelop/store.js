...
const SNIPPETS = {
  snippet0: {
    ...
    id: 'snippet0',
    sourcecode: require('raw-loader!@parity/shared/contracts/snippets/token.sol') // eslint-disable-line
  },
  snippet1: {
    ...
    id: 'snippet1',
    sourcecode: require('raw-loader!@parity/shared/contracts/snippets/standard-token.sol') // eslint-disable-line
  },
  snippet2: {
    ...
    id: 'snippet2',
    sourcecode: require('raw-loader!@parity/shared/contracts/snippets/human-standard-token.sol') // eslint-disable-line
  },
  snippet3: {
    name: 'Wallet.sol',
    description: (
    ...
    id: 'snippet3',
    sourcecode: require('raw-loader!@parity/shared/contracts/snippets/wallet.sol') // eslint-disable-line
  }
};
