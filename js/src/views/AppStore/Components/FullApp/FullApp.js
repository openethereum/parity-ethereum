    ...
    return (
      <div className={ styles.FullApp }>
          ...
          <div id={ styles.photoContainer }>
            <div id={ styles.photoSizedContainer }>
              ...
              <div id={ styles.photoGallery }>
                ...
                <div className={ styles.photos } id={ styles.first } ><img onClick={ () => { this.changePhoto(Photo1); } } src={ Photo1 } alt='Photo1' /></div>
                <div className={ styles.photoBorder } />
                <div className={ styles.photos } id={ styles.second }><img onClick={ () => { this.changePhoto(Photo2); } } src={ Photo2 } alt='Photo2' /></div>
                <div className={ styles.photoBorder } />
                <div className={ styles.photos } id={ styles.third } ><img onClick={ () => { this.changePhoto(Photo3); } } src={ Photo3 } alt='Photo3' /></div>
                <div className={ styles.photoBorder } />
        ...
        <div className='col-md-4' id={ styles.appInformationContainer }>
          ...
          <div className={ styles.rightSideBorderTopMargin } />
